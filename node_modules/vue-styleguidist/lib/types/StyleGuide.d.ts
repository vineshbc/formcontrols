...
export interface BaseStyleguidistConfig extends Omit<Rsg.SanitizedStyleguidistConfig, 'sections' | 'propsParser' | 'sortProps' | 'updateDocs'> {
    /**
    ...
    updateExample: (props: Pick<Rsg.CodeExample, 'content' | 'lang' | 'settings'>, ressourcePath: string) => Rsg.CodeExample;
