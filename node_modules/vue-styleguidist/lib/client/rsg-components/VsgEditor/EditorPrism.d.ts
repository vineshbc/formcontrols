...
export declare class UnconfiguredEditor extends Component<UnconfiguredEditorProps> {
    static propTypes: {
        ...
        editorPadding: PropTypes.Requireable<number>;
    };
    state: {
        code: string;
        prevCode: string;
...
declare const _default: React.ComponentType<Pick<Pick<UnconfiguredEditorProps, "code" | "classes" | "onChange" | "editorPadding">, "code" | "onChange" | "editorPadding">>;
