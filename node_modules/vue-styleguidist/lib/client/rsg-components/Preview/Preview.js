...
function (_Component) {
  ...
  _createClass(Preview, [{
    ...
    value: function executeCode() {
      ...
      try {
        var example = compile(code, _objectSpread({}, this.context.config.compilerConfig, {}, this.context.config.jsxInExamples ? {
          jsx: '__pragma__(h)',
      ...
      if (component && component.module && this.context.config.locallyRegisterComponents && // NOTA: if the components member of the vue config object is
      ...
      try {
        this.destroyVueInstance();
        this.vueInstance = new Vue(_objectSpread({}, extendsComponent, {}, rootComponent)).$mount(el);
      } catch (err) {
        this.handleError(err);
